...
function (_Product) {
  ...
  function CartProduct(product) {
    ...
    if (!product || !(product instanceof _Product2["default"])) {
      throw new Error('Product must be binded.');
    }

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CartProduct).call(this, product.title, product.price, product.category)); // super(product.title, product.price, product.category.title)
    ...
    _this.priceAfterDiscount = product.price * quantity;
    return _this;
  }
  /**
