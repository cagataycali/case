  ...
  _createClass(Cart, [{
    ...
    */
        ...
        */
        ...
        var findBestDiscount = function findBestDiscount(category) {
          ...
          if (discount && discount.apply(total) < min) {
            ...
            apply = categories.get(category.title) >= discount.delimiter; // apply = (discount.type === 'rate' ? categories.get(category.title) : total) >= discount.delimiter
            // Gotcha!
    ...
    value: function applyCoupon(coupon) {
      var total = this.totalAfterDiscount;
    ...
    */
    ...
    value: function getCampaignDiscounts(campaign) {
      return this.products.find(function (product) {
        return product.discount === campaign;
      });
    }
  }]);
