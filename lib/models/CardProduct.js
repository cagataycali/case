...
/* #__PURE__ */
(function (_Product) {
  _inherits(CardProduct, _Product)
  ...
  function CardProduct (product) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CardProduct).call(this, product.title, product.price, product.category.title))
